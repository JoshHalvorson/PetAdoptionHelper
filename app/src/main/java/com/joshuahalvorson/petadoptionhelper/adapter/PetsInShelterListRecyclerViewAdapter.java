...
public class PetsInShelterListRecyclerViewAdapter extends RecyclerView.Adapter<PetsInShelterListRecyclerViewAdapter.ViewHolder> {
    ...
    public PetsInShelterListRecyclerViewAdapter(
